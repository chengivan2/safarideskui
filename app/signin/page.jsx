    ...
    <div className="container relative flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center px-4 py-12">
      ...
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
        <div className="flex flex-col space-y-2 text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Enter your email to sign in to your account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm font-medium text-green-500 hover:text-green-600">
                  Forgot password?
                </Link>
              </div>
              <input
        ...
        <div className="text-center text-sm">
          ...
          <Link href="/signup" className="font-medium text-green-500 hover:text-green-600">
            Sign up
          </Link>
        </div>
      </div>
